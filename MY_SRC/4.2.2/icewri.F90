...
#  include "do_loop_substitute.h90"
   ...
   !! $OriginalId: icewri.F90 15388 2021-10-17 11:33:47Z clem $
...
CONTAINS
   ...
   SUBROUTINE ice_wri( kt )
      ...
      IF( iom_use('iceapeff' ) )  CALL iom_put( 'iceapeff', at_ip_eff  * zmsk00 )                                           ! melt pond total fraction (effective)
      ...
      IF( iom_use('icevlid_cat' ) )   CALL iom_put( 'icevlid_cat' ,   v_il         * zmsk00l                                   ) ! melt pond lid volume for categories
