...
CONTAINS
   ...
   SUBROUTINE stp_ctl( kt, Kmm )
      ...
      IF( ll_wrtruns ) THEN
         IF( ln_umax_ind ) THEN
            WRITE(numrun,9500) kt, zmax(1:jptst), iloc(:,2)
         ELSE
            WRITE(numrun,9501) kt, zmax(1:jptst)
         ENDIF
      ...
      ENDIF
      !
9500  FORMAT(' it :', i8, '    |ssh|_max: ', D23.16, ' |U|_max: ', D23.16,' S_min: ', D23.16,' S_max: ', D23.16, i8, i8, i8)
9501  FORMAT(' it :', i8, '    |ssh|_max: ', D23.16, ' |U|_max: ', D23.16,' S_min: ', D23.16,' S_max: ', D23.16)
      !
