MODULE ice
   ...
   LOGICAL , PUBLIC ::   ln_aip_lid_frz   !: Use a_ip instead of a_i in lid freezing in topographic melt ponds scheme   
   ...
   LOGICAL , PUBLIC ::   ln_pnd_ae_snw    !: set pond effective area to 0 if pond depth < snow depth
   ...
   !! $OriginalId: ice.F90 15388 2021-10-17 11:33:47Z clem $
...
CONTAINS
   ...
   FUNCTION ice_alloc()
      ...
      ii = ii + 1
      ALLOCATE( at_ip(jpi,jpj) , at_ip_eff(jpi,jpj) , hm_ip(jpi,jpj) , vt_ip(jpi,jpj) , hm_il(jpi,jpj) , vt_il(jpi,jpj) , STAT = ierr(ii) )
